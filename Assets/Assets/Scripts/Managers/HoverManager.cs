...
public class HoverManager : MonoBehaviour 
{
    ...
    public void ItemToShow(ItemProps itemAsGo) //takes item and shows its properties to the player
    {
        ...
        if (TheItem.itemType == ItemType.Gear)
        {
            ...
            else if (TheItem.mainStat.TheStat == MainStat.AttackSPD)
            {
                MainStatText1.text = "AttackSPD: " + TheItem.mainStat.TheValue;
            }
            else if (TheItem.mainStat.TheStat == MainStat.Health)
            {
                MainStatText1.text = "Health: " + TheItem.mainStat.TheValue;
            }
